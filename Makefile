...
DISTVERSION=	2.0.1
CATEGORIES=	devel
MASTER_SITES=	https://github.com/yzgyyang/freebsd-libcc-release/releases/download/v61.0.3163.100/
DISTFILES=	libchromiumcontent.tar.bz2 libchromiumcontent-static.tar.bz2
...
GH_TUPLE=	boto:boto:f7574aa:boto/vendor/boto \
		...
		electron:libchromiumcontent:0e76062:libchromiumcontent/vendor/libchromiumcontent \
		electron:native-mate:894c96f:native_mate/vendor/native_mate \
...
post-extract:
	...
	tar -xvf ${DISTDIR}/${DIST_SUBDIR}/libchromiumcontent.tar.bz2 -C \
		${WRKSRC}/vendor/download/libchromiumcontent/
	tar -xvf ${DISTDIR}/${DIST_SUBDIR}/libchromiumcontent-static.zip -C \
		${WRKSRC}/vendor/download/libchromiumcontent/
